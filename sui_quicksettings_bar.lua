...
local SLOTS_KEY_R      = "simpleui_qs_bar_slots_reader"
local SLOTS_KEY_FM      = "simpleui_qs_bar_slots_filemanager"
...
local function buildPanel(touch_menu)
    ...
    -- ── Action-button row ────────────────────────────────────────────────────
    local btn_size  = Screen:scaleBySize(54)
    local icon_size = math.floor(btn_size * 0.56)
