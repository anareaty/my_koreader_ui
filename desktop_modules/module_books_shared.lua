...
function SH.getBookCover(filepath, w, h, align, stretch_limit)
    ...
    local cover_container = FrameContainer:new{
    ...
    local cover_container = OverlapGroup:new{
        dimen = Geom:new{ w = w, h = h },
        img,
        VerticalGroup:new{
            HorizontalGroup:new{
                tl,
                HorizontalSpan:new{ width = w - corner_icon_size * 2 },
                tr
            },
            VerticalSpan:new{ width = h - corner_icon_size * 2 },
            HorizontalGroup:new{
                bl,
                HorizontalSpan:new{ width = w - corner_icon_size * 2},
                br
        ...
        FrameContainer:new{
            ...
            padding    = 0, margin = 0,
            VerticalGroup:new{
                HorizontalSpan:new{ width = w - border_size * 2 },
                VerticalSpan:new{ width = h - border_size * 2 },
            }
